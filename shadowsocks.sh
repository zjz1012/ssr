...
#   Author: zjz1012 <zjz1012@163.com>                             #
...
echo "# Author: zjz1012 <zjz1012@163.com>                         #"
echo "# Github: https://github.com/zjz1012/ssr                    #"
echo "#############################################################"
echo
...
pre_install(){
    ...
    read -p "(Default password: zjz1012.com):" shadowsockspwd
    [ -z "${shadowsockspwd}" ] && shadowsockspwd="zjz1012.com"
    echo
    echo "---------------------------"
